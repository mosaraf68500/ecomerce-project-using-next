...
import { ShoppingCart, Star, Users, Shield, Truck, Heart, Gift, MessageSquare } from "lucide-react"
...
export default function HomePage() {
  const featuredProducts = [
    {
      ...
      description: "Immersive audio with advanced noise cancellation and 20-hour battery life",
      price: 299.99,
      rating: 4.8,
    ...
    },
    {
      ...
      description: "Track fitness, heart rate, and sleep with a sleek, waterproof design",
      price: 199.99,
      rating: 4.6,
      image: "https://i.ibb.co/MyPz8Xq4/download.jpg",
    },
    {
      ...
      description: "Sustainable stainless steel bottle with double-wall insulation",
      price: 29.99,
      rating: 4.9,
      image: "https://i.ibb.co/MyPz8Xq4/download.jpg",
    },
  ...
  const testimonials = [
    {
      name: "Sarah M.",
      comment: "The quality of products at EcoShop is unmatched. Fast shipping and great support!",
      rating: 5,
    },
    {
      name: "James R.",
      comment: "Love the eco-friendly focus. The fitness watch is a game-changer!",
      rating: 4.7,
    },
    {
      name: "Emma L.",
      comment: "Amazing customer service and easy-to-use dashboard for managing my products.",
      rating: 4.9,
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link href="/products">
                <Button size="sm" className="bg-primary hover:bg-primary/90 px-4 py-2">
                  Shop Now
                </Button>
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
              Explore a curated selection of eco-friendly products, manage your inventory effortlessly, and shop securely with EcoShop.
            </p>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-serif font-bold text-3xl md:text-4xl text-foreground mb-4">Why Choose EcoShop?</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Experience seamless shopping and product management with our premium features.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 rounded-lg hover:bg-secondary/20 transition-colors duration-300">
              ...
              <h3 className="font-serif font-semibold text-xl mb-2">Fast & Free Shipping</h3>
              <p className="text-muted-foreground text-sm">Enjoy free delivery on orders over $50, delivered in 2-3 days.</p>
            </div>
            <div className="text-center p-6 rounded-lg hover:bg-secondary/20 transition-colors duration-300">
              <div className="bg-primary/10 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <Shield className="h-8 w-8 text-primary" />
              </div>
              <h3 className="font-serif font-semibold text-xl mb-2">Secure Transactions</h3>
              <p className="text-muted-foreground text-sm">Shop with confidence with our encrypted payment systems.</p>
            </div>
            <div className="text-center p-6 rounded-lg hover:bg-secondary/20 transition-colors duration-300">
              <div className="bg-primary/10 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <Users className="h-8 w-8 text-primary" />
              </div>
              <h3 className="font-serif font-semibold text-xl mb-2">24/7 Customer Support</h3>
              <p className="text-muted-foreground text-sm">Our team is here to assist you anytime, anywhere.</p>
            </div>
            <div className="text-center p-6 rounded-lg hover:bg-secondary/20 transition-colors duration-300">
              <div className="bg-primary/10 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <Gift className="h-8 w-8 text-primary" />
              </div>
              <h3 className="font-serif font-semibold text-xl mb-2">Exclusive Rewards</h3>
              <p className="text-muted-foreground text-sm">Earn points on every purchase and redeem exclusive offers.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-secondary/10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-serif font-bold text-3xl md:text-4xl text-foreground mb-4">Our Top Picks</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Discover our curated collection of high-quality, eco-conscious products.
            </p>
          </div>
            ...
            {featuredProducts.map((product) => (
              ...
              >
                ...
                <CardContent className="p-6">
                  ...
                  <CardTitle className="font-serif text-xl font-semibold mb-2">{product.name}</CardTitle>
                  <CardDescription className="text-muted-foreground text-sm mb-4 line-clamp-2">{product.description}</CardDescription>
                  <div className="flex items-center justify-between">
                    <span className="font-semibold text-2xl text-foreground">${product.price.toFixed(2)}</span>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-serif font-bold text-3xl md:text-4xl text-foreground mb-4">What Our Customers Say</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="bg-card border-border p-6 hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-0">
                  <div className="flex items-center mb-4">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`h-5 w-5 ${i < Math.floor(testimonial.rating) ? "fill-accent text-accent" : "text-muted-foreground"}`}
                      />
                    ))}
                  </div>
                  <p className="text-muted-foreground text-sm mb-4 italic">"{testimonial.comment}"</p>
      ...
      <section className="py-20 bg-primary/5">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="font-serif font-bold text-3xl md:text-4xl text-foreground mb-4">Stay Updated</h2>
            <p className="text-lg text-muted-foreground mb-8">
              Subscribe to our newsletter for exclusive offers, product updates, and eco-friendly tips.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <input
                type="email"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-background/80 mb-6 max-w-md text-sm">
                Your trusted destination for sustainable, high-quality products. Shop smart, live green, and manage effortlessly.
              </p>
              <div className="flex space-x-4">
                <Link href="https://twitter.com" className="text-background/80 hover:text-accent transition-colors">
                  <MessageSquare className="h-6 w-6" />
                </Link>
                <Link href="https://facebook.com" className="text-background/80 hover:text-accent transition-colors">
                ...
                <Link href="https://instagram.com" className="text-background/80 hover:text-accent transition-colors">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li>
                  <Link href="/dashboard" className="text-background/80 hover:text-accent transition-colors">
                    Admin Dashboard
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li className="text-background/80">Email: support@ecoshop.com</li>
                <li className="text-background/80">Phone: (123) 456-7890</li>
                <li className="text-background/80">Address: 123 Eco Lane, Green City</li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-background/20 mt-12 pt-8 text-center">
            <p className="text-background/60 text-sm">
              © {new Date().getFullYear()} EcoShop. All rights reserved. Built with Next.js and v0.
            </p>
          </div>
        </div>
      </footer>
